process DEEPTOOLS_BAM_COVERAGE {
    ...
    tag "DEEPTOOLS_BAM_COVERAGE_${sampleId}_${userId}_${strand}_${task.index}"
    ...
    script:
        ...
        bamCoverage \
            ...
            --outFileName ${sampleId}.${strand}.bw

        BIGWIG_MD5SUM=`md5sum ${sampleId}.${strand}.bw | awk '{print \$1}'`
        echo \$BIGWIG_MD5SUM  > ${sampleId}.${strand}.bw.md5sum
