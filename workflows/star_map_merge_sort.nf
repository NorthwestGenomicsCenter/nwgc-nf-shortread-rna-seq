...
workflow STAR_MAP_MERGE_SORT {
    ...
    emit:
        analysisTuple =SAMBAMBA_SORT.out.sortedByCoordinate_bam.merge(SAMBAMBA_SORT.out.sortedByCoordinate_bai).merge(STAR.out.transcriptome_bam).merge(STAR.out.spliceJunctions_tab) 
